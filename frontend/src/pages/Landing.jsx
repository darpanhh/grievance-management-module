...
const Landing = () => {
  ...
  return <div className="landing-page">
    ...
    <section className="stats-banner"><div className="stats-container"><div className="stat-card"><div className="stat-value">Clear</div><div className="stat-label">Status updates</div></div><div className="stat-card"><div className="stat-value">Private</div><div className="stat-label">Anonymous option</div></div><div className="stat-card"><div className="stat-value">6</div><div className="stat-label">Campus departments</div></div><div className="stat-card"><div className="stat-value">One place</div><div className="stat-label">For every update</div></div></div></section>
